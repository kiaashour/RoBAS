...
def main(dataset_name: str, model_name: str, embeddings_path: str, results_dir: str,
    ...
    """
    Run local conformal experiments on image datasets.
    ...
    model_name : str
        Predictive model backend for local conformal prediction.
    embeddings_path : str
...
def _build_arg_parser() -> argparse.ArgumentParser:
    """
    Build the command-line parser for image local conformal experiments.
    ...
    """
    parser = argparse.ArgumentParser(description="Run image local conformal experiments.")
